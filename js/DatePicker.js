     ...
     function refresh()
     {
     	...
     	$("#cellTableViewjqxcal td").each(bindCalendarDate);

        $('#jqxcal').on('backButtonClick', function()
        {

            $("#cellTableViewjqxcal td").each(resetCalendarDateColor);
     ...
     function resetCalendarDateColor()
     {
            $(this).css(
                {
